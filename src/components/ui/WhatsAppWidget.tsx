...
export function WhatsAppWidget() {
  return (
    ...
    >
      ...
      <svg
        viewBox="0 0 24 24"
        className="h-6 w-6 fill-[#25D366] opacity-80 transition-opacity duration-300 group-hover:opacity-100"
      ...
      {/* Tooltip */}
      <span className="pointer-events-none absolute right-14 whitespace-nowrap rounded-lg border border-white/10 bg-zinc-900/95 px-3 py-1.5 text-xs font-medium text-white/80 opacity-0 shadow-md transition-opacity duration-200 group-hover:opacity-100">
