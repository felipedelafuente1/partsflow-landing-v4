...
export const casos: Caso[] = [
  ...
  },
  {
    ...
    company: "Inalco",
    location: "Chile",
    headline: "-60% Tiempo de Respuesta",
  ...
  },
  {
    ...
    logo: "☀️",
    quote:
      '"Antes perdíamos ventas los fines de semana. Ahora la IA filtra todo y el lunes empezamos con la mesa servida."',
    ...
    resultsBody:
      "Con la atención 24/7 de Partsflow, cada consulta recibe respuesta inmediata sin importar el horario. La IA filtra y prepara las cotizaciones para que el equipo de ventas arranque el lunes con todo listo. Las ventas aumentaron un 40% en los primeros dos meses.",
    resultsPoints: [
